...
class dataSaver  extends pgsqlConnector{
    ...
    constructor(appalicationName, schema){
        ...
        this.#schema = schema;
        this.createDataTableQuery = 'CREATE TABLE IF NOT EXISTS %I.%I(datetime double precision NOT NULL,dev_data jsonb);';
        this.createUsersTableQuery = 'CREATE TABLE IF NOT EXISTS %I.%I(datetime double precision NOT NULL, dev_data jsonb);';
    ...
    /**
     * @desciption convert buffers to strings in device object
     * @param {object} parsed Dev Data
     * @return {object} converted data, prepared for insert
     */  
